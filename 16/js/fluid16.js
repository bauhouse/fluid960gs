window.addEvent('domready', function() {
  ...
  // Toggle Paragraphs
  var paragraphs2 = new Fx.Slide('paragraphs2').hide(); //creates new Fx.Slide object from paragraphs2 div
  $('toggle-paragraphs2').addEvent('click', function(e) { //Adds an onClick event to toggle-paragraphs2 div
    e = new Event(e);
      paragraphs2.toggle(); //toggles the div
    if ($('toggle-paragraphs2').hasClass('hidden')){
      $('toggle-paragraphs2').removeClass('hidden').addClass('visible');
    }
    else {
      $('toggle-paragraphs2').removeClass('visible').addClass('hidden');
    }
    e.stop(); //this makes sure that the user wont be sent to given url (or that the page refreshes when using dummy url like "#") if the clicked element was a link 
  });
  ...
  // Toggle Section Menu
  var sectionmenu2 = new Fx.Slide('section-menu2');
  $('toggle-section-menu2').addEvent('click', function(e) {
    e = new Event(e);
      sectionmenu2.toggle();
    if ($('toggle-section-menu2').hasClass('hidden')){
      $('toggle-section-menu2').removeClass('hidden').addClass('visible');
    }
    else {
      $('toggle-section-menu2').removeClass('visible').addClass('hidden');
    }
    e.stop(); 
  });
  ...
  // Toggle List Items 2
  var listitems2 = new Fx.Slide('list-items2');
  $('toggle-list-items2').addEvent('click', function(e) {
    e = new Event(e);
      listitems2.toggle();
    if ($('toggle-list-items2').hasClass('hidden')){
      $('toggle-list-items2').removeClass('hidden').addClass('visible');
    }
    else {
      $('toggle-list-items2').removeClass('visible').addClass('hidden');
    }
    e.stop(); 
  });
